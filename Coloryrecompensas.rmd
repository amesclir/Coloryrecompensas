...
color <- comparative.data(mytree2, mydata2, X2.Especies2, vcv=TRUE, vcv.dim=3)



result1 <- pgls(X27.Hue ~ X31.MeanAbsGC, color)

result2 <- pgls(X17.TamanofloralX ~ X11.Polenn, color)

result3 <- pgls(X17.TamanofloralX ~ X31.MeanAbsGC, color)
